defmodule Oidcc.Plug.RequireAuthorization do
  ...
  defmodule SampleAppWeb.Endpoint do
    ...
    plug Oidcc.Plug.RequireAuthorization,
      ...
      client_id: Application.compile_env!(:sample_app, [Oidcc.Plug.RequireAuthorization, :client_id]),
      client_secret: Application.compile_env!(:sample_app, [Oidcc.Plug.RequireAuthorization, :client_secret])
  ...
  import Plug.Conn, only: [put_private: 3, halt: 1, send_resp: 3, put_resp_header: 3]
